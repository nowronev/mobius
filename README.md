...
## Connectivity
The sample source introduces how to use Adafruit Feather M0 WiFi Board to connect CO2 sensor, RGB LED light and Relay module and connect to Mobius server platform.
